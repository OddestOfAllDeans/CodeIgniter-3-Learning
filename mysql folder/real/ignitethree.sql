...
insert  into `attendance`(`id`,`name`,`reason`,`attendance`,`time`) values 
(1,'Muhammad Ali Dean Baskoro Ajie',NULL,'attend','2024-05-02 11:13:00'),
(2,'Musky Stinky Ani Wanky','Sick','absent','2024-05-02 11:30:00'),
(3,'Angelina Josiah Trelawny',NULL,'attend','2024-05-02 11:36:00');
...
insert  into `mentors`(`id`,`nim`,`name`,`subject`,`birth_date`,`birth_place`) values 
(1,94802,'Sutrisno Bambang Yudhisyono','Physics','1984-06-12','Lagras, Yogyakarta'),
(2,32970,'Lebaksiputra Petrus Wicaksono','IT','1980-06-11','Saint Denis, Lampung'),
(3,73509,'Mukhti Nur Jakasutra','Mathematics','1992-04-23','Rhodes, Solo'),
(4,21409,'Jusmika Alputika Arya','Economics','1985-07-25','Valentine, Jakarta'),
(5,89217,'Justice Kelo Pakmata Sari','History','1978-12-12','Blackwater, Bogor'),
(6,53126,'Pomo Pirap Tirang Giga Nuganopso','Bahasa Indonesia','1988-09-23','New Austin, Palembang'),
(8,42188,'Musky Stinky Ani Wanky','Florian','1984-06-06','Morain, Pestaria');
...
(2,33856,'Muhammad Ali Dean Baskoro Ajie','Riau, Tembilahan','2005-08-20','M',12,16),
(3,43689,'Supri Bausaos Patriot','Solo','2003-07-18','M',3,11),
(104,29660,'Brigitta Lemonnier','Sudan','2004-12-11','M',3,8),
(105,11223,'Agneta Goodlife','China','2004-09-15','M',5,13),
...
insert  into `subjects`(`id`,`subjects`,`time`) values 
(1,'Mathematics','08:00:00'),
(2,'Economics','11:00:00'),
(3,'IT','14:00:00'),
(4,'Physics','17:00:00'),
(6,'Psychology','20:00:00');
